# ===============================
# client_2.py  (QNN + Moreau Envelope Personalization)
# ===============================
#
...
class FlowerClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        print(f"\n[CLIENT 2] Round {rnd} | Training started")
        ...
        print(f"[CLIENT 2] Training finished | Loss: {loss:.4f} | TPR (test): {tpr:.4f}")
    ...
    def evaluate(self, parameters, config):
        rnd = config.get("rnd", "N/A")
        print(f"\n[CLIENT 2] Round {rnd} | Evaluation started")
        ...
        acc = data["Accuracy"]
        print(f"[CLIENT 2] Evaluation accuracy: {acc:.4f}")
